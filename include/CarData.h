...
public:
    ...
    //method to generate visualization markers for the vehicle
    visualization_msgs::msg::MarkerArray toMarkerArray(const std::string &frame_id, const rclcpp::Time &stam) const;
};
